...
- (void)viewDidLoad
{
    ...
    NSLog(@"roomInfoUrl:%@", roomInfoUrl);
//    NSString* roomInfoUrl = [[NSString alloc] initWithFormat:@"https://appear.in/ubissbeta"];
...
//            kSessionId = [roomInfo objectForKey:@"sid"];
            kApiKey = @"45260162";
            kToken = @"T1==";
            kSessionId = @"2_MX40NTI2MDE2Mn5-MTQzNDEyOTczMTk4Mn5OTVFGVUlJaHZsQ016TGdzcllTOFFwR3h-fg";
